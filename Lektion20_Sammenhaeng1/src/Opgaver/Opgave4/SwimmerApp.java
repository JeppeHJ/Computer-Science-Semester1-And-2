...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        lapTimes.add(1.04);
        lapTimes.add(0.99);
        Swimmer s1 = new Swimmer("Jan", 1994, lapTimes, "AGF", levelA);
        ...
        lapTimes.add(1.04);
        lapTimes.add(1.02);
        Swimmer s2 = new Swimmer("Bo", 1995, lapTimes, "Lyseng", levelB);
        ...
        lapTimes.add(1.06);
        lapTimes.add(1.03);
        Swimmer s3 = new Swimmer("Mikkel", 1993, lapTimes, "AIA-Tranbjerg", levelB);
        ...
        levelA.removeSwimmer(s1);


        for (TrainingPlan tp: trainingPlans) {
            for (Swimmer swimmer: tp.getSwimmers()) {
