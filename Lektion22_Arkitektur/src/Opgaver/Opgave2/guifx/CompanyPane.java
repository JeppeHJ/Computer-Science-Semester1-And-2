...
public class CompanyPane extends GridPane {
	...
	public CompanyPane() {
		...
		addCustomerButton.setOnAction(event -> handleAddCustomerButton());

// Add the button to the layout
// Assuming you have a HBox or VBox named buttonContainer
		hbxButtons.getChildren().add(addCustomerButton);
	...
	private void handleAddCustomerButton() {
		...
		// If you chose to pass the selected company when creating the window:
		// customerSelectionWindow.setCompany(this.selectedCompany);
		customerSelectionWindow.initData();
		customerSelectionWindow.showAndWait();

		// If you need to update the company pane after the selection, do it here
	}
	...
	public void createCustomerAction() {
		CustomerWindow cW = new CustomerWindow(lvwCompanies.getSelectionModel().getSelectedItem());
		cW.showAndWait();
	}
